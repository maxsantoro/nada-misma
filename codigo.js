...
if (dineroCofla >= 0.6 && dineroCofla < 1 ){
    ...
    alert("lo siento cofla, pobre de mierda , no te alcanza para el helado");
}
...
if (dineroRoberto >= 0.6 && dineroRoberto < 1 ){
    ...
    alert("lo siento roberto, pobre de mierda , no te alcanza para el helado");
}
...
if (dineroPedro >= 0.6 && dineroPedro < 1 ){
    ...
    alert("lo siento pedro , pobre de mierda , no te alcanza para el helado");
}
